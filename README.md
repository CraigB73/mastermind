...
**Mastermind** is a Python terminal game that uses the command line you player to solve the secret code.
...
- Display message when player runs out of tries before secret code is solved.
- Good bye message if player choosed to not play again.

<img src= "./assets/screenshots/No.png" width=600 height=350>

- Input validation  
  - Incorrect input for difficult level 
  - Incorrect guess input for available letters
  
<img src= "./assets/screenshots/validation_test.png" width=600 height=350>

Play Mastermind: [MasterMind](https://master-mind-748a02ac12ee.herokuapp.com/)

## Data Model 

I use function base progamming as my model. The game creates a random secret code from a list of five letters: z,x,c,v, or b. Each code length is determinded by the player inputing their difficulty level through via command line.
...
- Total correct lettes in code sequence
- Total correct placement of lettes in code sequence
- Winner/Out of tries
- Play again
...
- Deployment steps:
  ...
  3. Link the Heroku app to [GitHub repository](https://github.com/CraigB73/mastermind.git)
  4. Click: <b>Deploy</B>
